 ...
 */
ol.format.XML.prototype.readFeaturesFromDocument = function(document) {
  goog.asserts.assert(document.childNodes.length == 1);
  return this.readFeaturesFromNode(document.firstChild);
};
